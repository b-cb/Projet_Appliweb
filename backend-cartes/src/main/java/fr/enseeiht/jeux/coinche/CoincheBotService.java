 ...
 */
@Service
public class CoincheBotService {

    private static final Logger log = LoggerFactory.getLogger(CoincheBotService.class);

    private final PartieRepository partieRepository;
    private final JoueurRepository joueurRepository;
    private final CoincheService jeuService;

    public CoincheBotService(PartieRepository partieRepository,
                      JoueurRepository joueurRepository,
                      @Lazy CoincheService jeuService) {
